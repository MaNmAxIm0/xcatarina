...
export function VideoGallery() {
  ...
  return <main>
    ...
    <footer className="public-footer"><a className="public-brand" href="#inicio"><span>xC</span><b>xCatarina</b></a><p>Arte, LEGO e um bocadinho de caos criativo.</p><nav className="social-links" aria-label="Redes sociais"><a href="https://www.instagram.com/xcatarina" target="_blank" rel="noreferrer">Instagram</a><a href="https://tipme.to/xcatarina/" target="_blank" rel="noreferrer">TipMe</a><a href="https://www.tiktok.com/@xcataarina" target="_blank" rel="noreferrer">TikTok</a><a href="https://www.tiktok.com/@clipsdaxcatarina" target="_blank" rel="noreferrer">Clips</a></nav></footer>
  </main>;
}
