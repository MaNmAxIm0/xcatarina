...
export function VideoGallery() {
  ...
  return <main>
    <header className="public-nav"><a href="#inicio" className="public-brand"><span>xC</span><b>xCatarina</b></a><nav aria-label="Navegação principal"><a href="#videos">Vídeos</a><a href="https://www.twitch.tv/xcatarina" target="_blank" rel="noreferrer">Twitch</a><a href="https://www.instagram.com/xcatarina" target="_blank" rel="noreferrer">Instagram</a><a href="https://tipme.to/xcatarina/" target="_blank" rel="noreferrer">TipMe</a><a href="https://www.tiktok.com/@xcataarina" target="_blank" rel="noreferrer">TikTok</a><a href="https://www.tiktok.com/@clipsdaxcatarina" target="_blank" rel="noreferrer">Clips</a></nav></header>
    <section className="public-hero" id="inicio"><div className="hero-copy"><span className="live-kicker">ARTE, LEGO & BOAS VIBES</span><h1>As criações<br/>ganham <em>vida.</em></h1><p>Timelapses das lives da xCatarina — da primeira peça ao último detalhe.</p><a className="watch-button" href="#videos">Ver todos os vídeos <span>↓</span></a></div><div className="hero-art" aria-label="Composição abstrata inspirada em arte e LEGO"><div className="sun"/><div className="blue-card"><span>✦</span><b>CRIAR</b></div><div className="pink-card"><i/><i/><i/><i/><i/><i/></div><div className="scribble">feito<br/>com amor</div></div></section>
