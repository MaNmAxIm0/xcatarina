...
export function VideoGallery() {
  ...
  return <main>
    ...
    <footer className="public-footer"><a className="public-brand" href="#inicio"><span>xC</span><b>xCatarina</b></a><p>Arte, LEGO e um bocadinho de caos criativo.</p><a href="https://xcatarina-timelapse-studio.vercel.app" target="_blank" rel="noreferrer">Abrir estúdio</a></footer>
  </main>;
}
